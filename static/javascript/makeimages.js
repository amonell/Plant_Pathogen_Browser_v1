function clusterfind() {
    ...
    var server_data = [
    {"num0": zero, "num1": one, "num2": two, "num3": three, "num4": four, "num5": five, "num6": six, "num7": seven, "num8": eight, "num9": nine, "num10": ten, "num11": eleven, "num12": twelve, "num13": thirteen, "num14": fourteen, "num15": fifteen, "num16": sixteen, "num17": seventeen, "p_experiment": "current", "p_experiment2": "current", "pseudotime": "none","Transcripts": transcripts, "experiment": "current", "experiment2": "current"}
    ];
    $.ajax({
    url: "/index",
